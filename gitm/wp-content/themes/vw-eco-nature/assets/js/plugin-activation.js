jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_eco_nature_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-eco-nature-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-eco-nature-plugin-install');
                button.addClass('button-primary vw-eco-nature-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-eco-nature-recommended-plugins .vw-eco-nature-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-eco-nature-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-eco-nature-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-eco-nature-recommended-plugins').css('display','none');
    });
