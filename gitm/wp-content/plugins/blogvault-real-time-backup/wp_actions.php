	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '20dde8a0feed28bf2bdea63e1b21a1d0', '0b9ef4f7229d64079471fdf4463cf9e1');
		BVAccount::updateApiPublicKey($this->settings, '20dde8a0feed28bf2bdea63e1b21a1d0');
			}
